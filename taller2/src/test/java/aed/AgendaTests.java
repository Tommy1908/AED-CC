...
public class AgendaTests {
    ...
    void fechaComoString() {
        ...
        Fecha fecha1 = new Fecha(9, 2);
        String esperado1 = "9/2";

        assertEquals(esperado, fecha.toString());
        assertEquals(esperado1, fecha1.toString());
    }
    ...
    void incrementarDia() {
        ...
        Fecha f3 = new Fecha(31,12);
        f3.incrementarDia();
        assertEquals(1, f3.dia());
        assertEquals(1, f3.mes());
    }
